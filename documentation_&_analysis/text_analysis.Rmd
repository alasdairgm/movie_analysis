---
title: "Text analysis of movie synopses"
output:
  html_document:
    toc: true # contents
...
In this analysis I read in my cleaned movies data (taken from IMDB) to examine
the movie synopses and perform text analysis on the words contained within.
...
just_words %>% 
  ...
  slice_max(abs_value, n = 5) %>%  # most emotive words, regardless of positive or negative
